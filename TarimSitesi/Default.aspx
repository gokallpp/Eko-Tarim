...
<head>
    <title>EkoTarım</title>
    <!-- Meta tag Keywords -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="UTF-8" />
    <meta name="keywords" content="Proje" />
    <script>
...
<body>
            ...
            <div class="container-fluid px-lg-4">
                <nav class="py-4">
                    <div class="logo" id="logo">
                        <a href="web/images/logo.png">EkoTarım</a>

                    </div>
                    <label for="drop" class="toggle">Menu</label>
                    <input type="checkbox" id="drop">
                    <ul class="menu mt-md-3">
                        <li class="mr-lg-2 active"><a href="default.aspx">Ana Sayfa</a></li>
        ...
        <div class="container py-lg-5">
            <div class="row about-info-augue">
                <div class="col-md-4 about-aug about-aug1">
                    ...
                    <a href="#news" class="btn button-style mt-sm-5 mt-4 scroll">Daha Fazla</a>
                </div>
    ...
    <div class="cpy-right text-center py-5">
        ...
        <p>
            © 2024  Eko Tarım Hayvancılık. Tüm Hakları Saklıdır. | 
            <a href=>info@ekotarim.com.tr  <br> EkoTarım.</a>
        </p>
    </div>
    <!-- //footer -->
</body>
